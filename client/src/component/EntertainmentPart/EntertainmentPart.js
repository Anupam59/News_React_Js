...
class EntertainmentPart extends Component {
    ...
    componentDidMount() {
        axios.get(ApiUrl.NewsListCategoryEight("entertainment")).then(response=>{
        ...
        return (
            <Fragment>
                <Container className="ContainerFull">
                    <h3 className="TitlePartText">বিনোদন</h3>
                    <Row className="mb-3">
                        ...
                        <Col xl={5} lg={5} md={12} sm={12}>
                            ...
                            <Row>
                                <Col xl={6} lg={6} md={12} sm={12} className="PlayHome">
                        ...
                        <Col xl={7} lg={7} md={12} sm={12}>
                            <Row>
                                <Col xl={5} lg={5} md={12} sm={12}>
                                    <Row>
                                        <Col xl={12} lg={12} md={12} sm={12} className="Entertainment">
